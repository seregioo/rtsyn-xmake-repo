...
local package_name = "rtsyn-spsc"

package(package_name)

set_homepage("https://github.com/seregioo/" .. package_name)
set_description("C library for creating a SPSC for RTSyn")
set_license("GPL-3.0-or-later")

add_deps("rtsyn-abi", "rtsyn-defaults")
rtsyn_source(package_name, "https://github.com/seregioo/" .. package_name .. ".git")

rtsyn_install(package_name)

on_test(function(package)
	assert(package:has_cincludes("rtsyn/spsc.h"))
end)
